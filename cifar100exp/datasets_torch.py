...
def get_facescrub_bothloader(batch_size=16, num_workers=2, shuffle=True, num_client = 1, collude_use_public = False):
    ...
    # Default root (recommended): ./data/facescrub/{train,val}/<class_name>/*.jpg
    # Fallbacks are supported for legacy layouts.
    ...
    # Legacy fallback: repo-prepared FaceScrub subset (if already present locally).
