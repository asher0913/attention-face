#!/bin/bash
# =============================================================================
# run_exp1.sh — CIFAR-100 CEM-fixed sweep (20 experiments)
#   Same hyperparams as cem-fixed/run_exp.sh but on CIFAR-100
#
# Usage     : bash run_exp1.sh [GPU_ID]          (default GPU=0)
...
run_exp1.sh  —  CIFAR-100 CEM-fixed sweep (same hyperparams as cem-fixed FaceScrub)
...
lm "======================================================================"
lm " run_exp1.sh |  CIFAR-100 CEM-fixed sweep  |  GPU ${GPU_ID}"
lm " Run dir  :  ${RUN_DIR}"
lm "======================================================================"
