#!/bin/bash
# =============================================================================
# run_no.sh — TinyImageNet Noise_Nopeek+CEM(SlotAttn) sweep  (16 experiments)
#   Directly comparable to paper Table 2 "Noise_Nopeek+CEM" on TinyImageNet
#   Fixed: nopeek defense, σ=0.025, λ=16, 120 epochs (matching paper)
...
run_no.sh  —  TinyImageNet Noise_Nopeek+CEM(SlotAttn) sweep
...
Purpose: Compare SlotAttn CEM vs GMM CEM on TinyImageNet
  ...
  Compare against: Paper Table 2 Noise_Nopeek+CEM on TinyImageNet
    Acc=52.01, Dec Infer MSE=0.0180, GAN Infer MSE=0.0167
...
Paper Table 2 Noise_Nopeek+CEM on TinyImageNet:
  Acc=52.01, Dec Infer MSE=0.0180, GAN Infer MSE=0.0167
RDEOF

lm "======================================================================"
lm " run_no.sh  |  TinyImageNet Noise_Nopeek+CEM(SlotAttn) sweep  |  GPU ${GPU_ID}"
lm " Run dir  :  ${RUN_DIR}"
lm "======================================================================"
...
EXPERIMENTS=(
  "exp01  16  0.025  0.15  1.0   8  3   64   64  3  120"
  "exp02  16  0.025  0.15  1.0   8  3   64  128  3  120"
  "exp03  16  0.025  0.15  1.0   8  3   64  256  3  120"
  "exp04  16  0.025  0.15  1.0   4  3   64  128  3  120"
  "exp05  16  0.025  0.15  1.0  12  3   64  128  3  120"
  "exp06  16  0.025  0.15  1.0   8  5   64  128  3  120"
  "exp07  16  0.025  0.15  1.0   8  3   32  128  3  120"
  "exp08  16  0.025  0.15  1.0   8  3  128  128  3  120"
  "exp09  16  0.025  0.10  0.5   8  3   64  128  3  120"
  "exp10  16  0.025  0.15  1.0   8  3   64  128  5  120"
  "exp11  16  0.025  0.20  2.0   8  3   64  128  3  120"
  "exp12  16  0.025  0.15  1.5   8  5   64  128  3  120"
  "exp13  16  0.025  0.15  1.0  12  5  128  128  5  120"
  "exp14  16  0.025  0.20  1.5   8  5  128  256  3  120"
  "exp15  16  0.025  0.15  1.0   4  5   64   64  3  120"
  "exp16  16  0.025  0.20  1.0  12  3  128  256  5  120"
)
...
for ENTRY in "${EXPERIMENTS[@]}"; do
    ...
    FOLDER="saves/tinyimagenet/${AT_REG}_cemfixed_lg${LOG_ENTROPY}_vt${VT}"
...
print('-' * W)
print("  Paper Table 2 Noise_Nopeek+CEM: Acc=52.01, Dec Infer MSE=0.0180, GAN Infer MSE=0.0167")
print()
